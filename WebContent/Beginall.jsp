...
<head>
  ...
  <link href="${pageContext.request.contextPath}/resources/css/beginall.css" rel="stylesheet">
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/resources/js/beginall.js"></script>
   </head>
<body >
<div class="top">
